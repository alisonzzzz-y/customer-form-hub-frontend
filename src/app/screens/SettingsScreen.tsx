...
function ToggleRow({
  ...
  return (
    <label className="flex items-center justify-between gap-4 py-2.5 cursor-pointer group">
      <div>
        <p className="text-xs font-medium text-[#1F2937]">{label}</p>
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      <div className="px-7 pt-6 pb-4 bg-white border-b border-[rgba(0,0,0,0.06)] shrink-0 flex items-center justify-between">
        ...
        {dirty && (
          <span className="text-[10px] font-semibold text-[#C05600] bg-[#FFF4EC] border border-[#F96702]/25 rounded-full px-3 py-1">
            Unsaved changes
          </span>
        )}
      </div>
      <div className="flex-1 overflow-auto px-8 py-7">
        <div className="max-w-2xl mx-auto flex flex-col gap-5">
          ...
          <div className="flex gap-2">
            ...
            <BtnSecondary onClick={() => setScreen("dashboard")}>
